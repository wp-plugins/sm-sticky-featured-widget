...
class WP_Widget_smSticky extends WP_Widget {
	...
	//used to store defaults for easy parsing during admin form creation
	protected $defaults;

	//init options and defaults for widget admin area
	function __construct(){
		...
		//setup default widget options
		parent::__construct(
			'WP_Widget_smSticky',
			esc_html__( 'SM Sticky Posts', 'sm-sticky-widget' ),
			array(
				'classname'   => 'widget_smStickyt',
				'description' => __( 'SM Sticky Featured Posts', 'sm-sticky-widget' ),
			)
		);
	...
	function form($instance) {
		//setup values in cases where no values exist yet (ie upon creation)
